...
filter: \["has", "point\_count"\],
layout: {
"text-field": "{point\_count\_abbreviated}",
"text-font": \["Open Sans"\],
"text-size": 12,
},
paint: {
...
const clusterId = feature.properties?.cluster\_id as number;
const pointCount = feature.properties?.point\_count as number;
