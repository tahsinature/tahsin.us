...
const Footer = () => {
  return (
    <div className="py-5 mt-20 bg-[#fbeed5] dark:bg-[#0810169e]">
      <div className="container">
        ...
        <div className="flex">
          ...
          <div className="ml-auto mt-auto mb-6">
            <h1 className="md:text-lg text-sm text-right">Let&apos;s keep in touch!</h1>
