...
const ThemeToggle = () => {
  ...
  // let currentBtnClass = classMap.dark;
  // // const currentBtnClass = classMap[theme as any];
  // if (theme && classMap[theme]) {
  //   currentBtnClass = classMap[theme];
  // }
  ...
  // return (
  //   <button className={[classes.ThemeToggle, currentBtnClass].join(" ")} aria-label="theme change" onClick={changeTheme}>
