...
export const trips: TripFolder[] = [
  ...
  },
  {
    ...
    photos: [
      ...
      {
        src: "https://images.unsplash.com/photo-1569701813229-33284b643e46?w=800&q=80",
        alt: "Chefchaouen blue streets",
        meta: { camera: "Canon R6 II", lens: "24-105mm f/4 L", focalLength: "24mm", aperture: "f/5.6", shutterSpeed: "1/160s", iso: "200", location: "Medina, Chefchaouen" },
      },
      {
