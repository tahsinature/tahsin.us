        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-4" staggerDelay={0.07}>
          ...
          <StaggerItem variant="scale">
            <BentoCard className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                I work across multiple languages and stacks daily — from <span className="text-accent font-semibold">Python</span> and <span className="text-primary font-semibold">Java</span>{" "}
                on the backend, to <span className="text-accent font-semibold">TypeScript</span> on the front.
              </p>
              <p className="text-muted-foreground text-sm">
